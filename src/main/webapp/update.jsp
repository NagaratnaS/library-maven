...
<script>
	function validateForm() {
		const libraryID = document.forms["updateForm"]["libraryID"].value;
		const libraryName = document.forms["updateForm"]["libraryName"].value;
...
<body>
  ...
  <h2>Update Library Info</h2>
  <form action="update" name="updateForm" onsubmit="return validateForm()">
